...
export const notes: Note[] = [
  { title: "為什麼只有 EXIF Orientation 還不夠", description: "從實務角度解析影像方向中繼資料，以及電腦視覺管線仍需補上的檢查。", category: "電腦視覺", visual: "exif", href: "#" },
  { title: "理解 LangChain Runnable", description: "認識如何透過 Runnable sequence，組合出更穩定、可預期的 AI 應用流程。", category: "AI 工程", visual: "runnable", href: "#" },
  { title: "從 GeoTIFF 到高程資料回填", description: "探討如何運用網格高程資料，讓空間分析與路線資訊更加完整。", category: "資料系統", visual: "terrain", href: "#" },
];
